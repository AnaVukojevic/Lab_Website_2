...
function switchPlayers(playerNum){
    ...
    document.getElementById("avg_p_yards").innerHTML = parseInt(avg_p_yards);
    var avg_r_yards = players[playerNum].rushing_yards/players[playerNum].games_played;
    document.getElementById("avg_r_yards").innerHTML = parseInt(avg_r_yards);
